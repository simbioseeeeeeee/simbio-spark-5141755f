...
CREATE OR REPLACE FUNCTION public.get_manager_analytics(p_cidade text DEFAULT NULL::text, p_days integer DEFAULT 1)
 RETURNS TABLE(total_leads_qualificados bigint, total_atividades bigint, total_reunioes bigint, total_fechamentos bigint, valor_pipeline numeric, total_desqualificados bigint)
 LANGUAGE sql
 STABLE
